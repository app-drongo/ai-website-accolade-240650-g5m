...
const DEFAULT_FOOTER = {
  logoText: 'Accolade',
  companyDescription:
    'Empowering organizations with innovative recognition and performance management solutions. Join thousands of companies who trust Accolade to drive employee engagement and business success.',
  ...
  newsletterDisclaimer:
    'Get insights on employee recognition trends and product updates. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Accolade. All rights reserved.',
  madeWithText: 'by the Accolade team',
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Admin Dashboard', href: '/admin', editableId: 'link-footer-admin' },
      ],
    },
    {
  ...
  const bottomLinks = [
    ...
    { name: 'Trust Center', href: '/trust', editableId: 'link-footer-trust' },
