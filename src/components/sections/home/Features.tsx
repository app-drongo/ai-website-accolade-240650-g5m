...
const DEFAULT_FEATURES = {
  ...
  feature3Title: 'Mobile Expense Management',
  feature3Description:
    'Capture receipts, track mileage, and manage expenses on-the-go with our intuitive mobile app for busy entrepreneurs.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Entity Management',
  feature4Description:
    'Manage multiple business entities, subsidiaries, and locations from a single dashboard with consolidated reporting.',
  feature4Badge: 'Multi-Business',
  feature5Title: 'Advanced Financial Reports',
  feature5Description:
    'Generate P&L statements, balance sheets, and cash flow reports with 40+ customizable financial report templates.',
  feature5Badge: 'Reporting',
  feature6Title: 'Custom Approval Workflows',
  feature6Description:
    'Set up automated approval processes for expenses, invoices, and payments to maintain financial control.',
  feature6Badge: 'Automation',
  feature7Title: 'Banking & Payment Integrations',
  feature7Description:
    'Connect with 12,000+ banks and payment processors for seamless transaction import and payment processing.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Accounting Support',
  feature8Description:
    'Access certified bookkeepers and tax professionals with unlimited support and quarterly business reviews.',
  feature8Badge: 'Support',
  feature9Title: 'Bank-Level Data Security',
  feature9Description:
