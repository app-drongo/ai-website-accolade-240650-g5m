...
const DEFAULT_HERO = {
  ...
  title: 'Streamline your small business',
  titleHighlight: 'accounting & finances',
  description:
    'Automate bookkeeping, track expenses, and generate financial reports in minutes. Built specifically for small business owners who need professional accounting without the complexity.',
  features: [
