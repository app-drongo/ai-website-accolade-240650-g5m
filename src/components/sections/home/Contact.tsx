...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small businesses who trust Accolade to streamline their accounting. Our team is here to help you get started with a personalized demo.',
  formTitle: 'Schedule Your Free Demo',
  formDescription:
    "Get a personalized walkthrough of Accolade's features and see how we can save you 10+ hours per week on bookkeeping.",
  ...
  office1City: 'Austin, TX',
  office1Address: '2100 Financial Plaza, Suite 400',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Denver, CO',
  office2Address: '1850 Business Center Dr, Floor 12',
  office2Timezone: 'MST (UTC-7)',
  office3City: 'Atlanta, GA',
  office3Address: '3300 Peachtree Rd, Building C',
  ...
  messagePlaceholder:
    "I'm looking for help with monthly bookkeeping, tax preparation, and financial reporting for my retail business...",
} as const;
